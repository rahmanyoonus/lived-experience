/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 49129915684592b978b45fc70e85dc93)
// Runtime types generated with workerd@1.20260714.1 2026-07-19 enable_request_signal,nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	OPENAI_API_KEY: string;
	RATE_LIMIT_SECRET: string;
	RATE_LIMITER: DurableObjectNamespace<import("./worker/index").TranscriptionRateLimiter>;
	SPEND_GATE: DurableObjectNamespace<import("./worker/index").TranscriptionSpendGate>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "TranscriptionRateLimiter" | "TranscriptionSpendGate";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "RATE_LIMIT_SECRET">> {}
}
